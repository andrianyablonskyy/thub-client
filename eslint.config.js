 ...
 * @description ESLint flat config for @andrian.yablonskyy/thub-client: stylistic/promise rules plus Node globals
 *
...
module.exports = [
  { ignores: ['**/node_modules/**', '.data/**'] },
  {
    ...
    rules: {
      ...
      'no-var': 'error',
      // console.log/error *is* this daemon's actual output mechanism
      // (job status, registration/heartbeat/poll errors), not leftover
      // debugging.
      'no-console': 'off',
